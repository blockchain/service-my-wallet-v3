...
If you already have an application that uses [Blockchain.info's Wallet API][WalletApi], you will need to complete the steps in the Getting Started section above and then, in your application code, replace calls to `blockchain.info/merchant/...` with `localhost:<port>/merchant/...`.

## API Documentation

View the [original documentation][WalletApi].
...
[WalletApi]: https://blockchain.info/api/blockchain_wallet_api
